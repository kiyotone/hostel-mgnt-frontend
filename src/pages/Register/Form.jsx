  ...
  return (
    <div className='bg-white w-[35rem] h-[40rem] rounded-md text-black'>
            ...
            <form className='text-[.9rem]'>
              ...
              <input placeholder=' ' value={values.name} onBlur={handleBlur} onChange={handleChange} type='text' id='name' className={`w-[25rem] h-[3rem] p-5 bg-gray-50 peer border-black placeholder-shown:border-gray-200 border rounded-full ${errors.name && touched.name &&  "border-red-600"}`}></input>
              ...
              <div className='relative mt-[2rem]'>
              <input placeholder=' ' value={values.email} onBlur={handleBlur} onChange={handleChange} type='text' id='email' className={`w-[25rem] h-[3rem] p-5 bg-gray-50 peer border-black placeholder-shown:border-gray-200 border rounded-full ${errors.email && touched.email &&  "border-red-600"}`}></input>
              ...
              <div className='relative mt-[2rem]'>
              <input placeholder=' ' value={values.password} onBlur={handleBlur} onChange={handleChange} type='text' id='password' className={`w-[25rem] h-[3rem] p-5 bg-gray-50 peer border-black placeholder-shown:border-gray-200 border rounded-full ${errors.password && touched.password &&  "border-red-600"}`}></input>
              ...
              <div className='relative mt-[2rem]'>
              <input placeholder=' ' value={values.mobile} onBlur={handleBlur} onChange={handleChange} type='text' id='mobile' className={`w-[25rem] h-[3rem] p-5 pl-[4rem] bg-gray-50 peer border-black placeholder-shown:border-gray ${errors.mobile && touched.mobile &&  "border-red-600"}-200 border rounded-full`}></input>
